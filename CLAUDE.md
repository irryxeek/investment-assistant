...
- **大盘概览**：上证、深证、恒生指数
- **宏观环境**：USD/CNH 汇率、美元指数、美债10Y收益率、恒生波指
- **持仓详情**：实时行情 + 技术指标（RSI、MA、MACD、区间位置）
- **基本面估值**：PE、股息率（中证指数官网 + multpl.com）
- **资金面**：A股主力资金流向、港股通南向资金
- **财经要闻**：新浪7x24 + 财联社快讯（自动采集，约15条）

`/driven` 分析时会额外通过 WebSearch 搜索当日要闻，补充消息面上下文（特别是技术面异动的基本面原因）。
